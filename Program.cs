namespace FirstProject
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            addressBook1.ViewByCity();  // UC9 and UC10

            AddressBook.PrintSortedByName(addressBook2); // UC11

            AddressBook.PrintSortedByCity(addressBook1);

            AddressBook.WriteToFile(addressBook2, "sample");
